...
# Then compare against decision criteria (> 0.5) to predict the class (confidence[0] = "<=50K", confidence[1] = ">50K")
...
accuracy = predictionsCorrect / len(incomeTestResult)
print(accuracy)
